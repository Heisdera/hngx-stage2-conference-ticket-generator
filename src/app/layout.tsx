  ...
  return (
    <html lang="en">
      <body
        ...
        className={`${roboto.className} ${jejuMyeongjoLocalFont.className} dark antialiased min-h-screen bg-[#07181C] sm:bg-[radial-gradient(52.52%_32.71%_at_50%_97.66%,rgba(36,160,181,0.20)_0%,rgba(36,160,181,0.00)_100%)] sm:from-[#4E9EB3] sm:to-[#07181C] sm:to-60% text-white p-5`}
      >
        {children}
      </body>
    </html>
